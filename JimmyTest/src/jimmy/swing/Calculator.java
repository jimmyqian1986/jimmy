...
public class Calculator {
    ...
    JTextField result_TextField = new JTextField(result, 30);// 20列
    JButton clear_Button = new JButton("AC");
    ...
    public void cal() {
        ...
        if (c.equals("")) {
            ...
            if(new Double(result2)>10000000){
            	result_TextField.setText("超出运算符");
            }
            else{
            	result_TextField.setText(result);
            }
